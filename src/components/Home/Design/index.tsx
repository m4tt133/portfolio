        ...
        <section className="wrapper-padding-y flex justify-between w-full gap-10 lg:flex-col">
            <div className="flex flex-col gap-10 w-1/2 lg:w-full">
                ...
                <div className="flex flex-col text-[14px] gap-4">
                    <p className="font-semibold">I am a developer and also designer.</p>
                    <p>I have built my career around the idea that software should be beautiful, as well as functional, because it is not just about how things look, but also about how they feel.</p>
                    <p>I believe that design is more than just an aesthetic choice: it is an important part of how we interact with the digital world, and how we connect with each other. As such, I work hard to ensure that every project I take on is designed in such a way that makes users feel connected with the product and its creators.</p>
                </div>
            </div>

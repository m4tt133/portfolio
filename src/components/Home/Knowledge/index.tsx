    ...
    return(
        <section className="wrapper-padding-y flex flex-col  gap-5">
            ...
            <div className="flex flex-col text-[14px] gap-4">
                <p className="font-semibold">I'm a big believer in the power of knowledge. </p>
                ...
                <p>The courses resolving around B2B marketing and Sales gave an opportunity to better understand the clients needs, and that's why I can manage to talk to clients about their business, since building software is just a leverge tool to scale.</p>
            </div>
